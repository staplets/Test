 ...
 * Date: 07/08/14
 * Solution description: Program will have ability to use a dynamic array for
 * different areas of manipulation including the stack data structure.
 */
...
TYPE getDynArr(DynArr *v, int pos)
{
	...
	/* FIXME: you must change this return value */  //****Worked on
	//return 1;
}
...
void removeAtDynArr(DynArr *v, int idx)
{
    ...
    //Check for allocating outside of array.
    if(idx >= (v->size + 1))
    {
        printf("Deletion not possible.\n");
    }
    else
    {   //adjust values according to index.
